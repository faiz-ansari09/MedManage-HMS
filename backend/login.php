      ...
      <div class="row m-0">
        <div class="col-12 p-0">
          <div class="login-card login-dark">
            <div>
              <div><a class="logo" href="index.html"><img class="img-fluid for-light" src="assets/images/Screenshot_2024-10-21_at_12.39.53_PM-removebg-preview.png" alt="looginpage" style="width:300px"><img class="img-fluid for-dark" src="assets/images/Screenshot_2024-10-21_at_12.39.53_PM-removebg-preview.png" alt="looginpage"></a></div> 
              
              <div class="login-main">
                <form class="theme-form" action="insertlogin.php" method="post">
                  ...
                  <div class="form-group mb-0">
                    ...
                    <button class="btn btn-primary btn-block w-100" type="submit">Proceed</button>
                  </div>
                  
                </form>
                <br>
                <a href="Registration.php"><button class="btn btn-danger">Registration</button></a>
              </div>
            </div>
          </div>
        </div>
